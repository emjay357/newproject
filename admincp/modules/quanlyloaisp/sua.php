...
<table width="200" border="1">
  <tr>
    <td colspan="2" style="text-align:center; font-size:25px">Product type fix</td>
  </tr>
  <tr>
    <td width="97">Product type</td>
    <td width="87"><input type="text" name="producttype" value="<?php echo $dong['loaisp'] ?>"></td>
  </tr>
  <tr>
    <td width="97">Product type name</td>
    <td width="87"><input type="text" name="producttype" value="<?php echo $dong['tenloaisp'] ?>"></td>
  </tr>
  <tr>
    <td>Status</td>
