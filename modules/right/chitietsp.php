...
?>
	<div class="tieude">Product details</div>
                	...
                	<div class="box_chitietsp">
                        ...
                        <div class="box_info">
                         <form action="update_cart.php?id=<?php echo $dong['productid'] ?>" method="post" enctype="multipart/form-data">
                        	<p>
                            	<strong>Tên sản phẫm: <em style="color:red"><?php echo $dong['productname'] ?></em></strong></p>

                                           <p><strong>Mã sản phẩm:</strong>  <?php echo $dong['masp'] ?> </p> 
                                           <p><strong>Giá bán:</strong><span style="color:red;"> <?php echo number_format($dong['price']).' '.'VND'?></span></p> 
              		...
              		<div class="tabs_panel">
                        ...
                        <?php
					$sql_thongtinsp=mysqli_query($conn, "select * from sanpham where productid='$_GET[id]'");
					$count_thongtinsp=mysqli_num_rows($sql_thongtinsp);
					$sql_productorder=mysqli_query($conn, "select productorder from sanpham where productid='$_GET[id]'");
				...
				?>
                   ...
                   <?php
				   	$sql_lienquan="select * from sanpham where producttype='$_GET[idloaisp]' and sanpham.productid<>$_GET[id] ";
                    ...
                    <div class="sanphamlienquan">
                   	<div class="tieude">Related products</div>
						...
						?>
                            ...
                            <p>Product name : <?php echo $dong_lienquan['productname'] ?></p>
